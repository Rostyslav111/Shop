      ...
      <div>
        <div style={{ padding: 10, display: "flex", alignItems: "center" }}>
          <div style={{ flex: 1, fontSize: 24 }}>
            <div>{category ? category : "Популярні товари"}</div>
            {subtitle}
          </div>
          ...
          >
            <MenuItem value={"lh"}>Сортувати за ціною: від низької до високої</MenuItem>
            <MenuItem value={"hl"}>Сортувати за ціною: від високої до низької</MenuItem>
          </Select>
        </div>
